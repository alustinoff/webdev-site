var Slider = function (container) {
  var nextBtn = container.find('.works-slider__control-btn_left'),// левая  кнопка
    ...
    title = container.find('.slider__title'), // заголовок слайда
    skills = container.find('.slider__technologies'), // технологии
    link = container.find('.site-to-link'), // ссылка
  ...
  var changeMainPicture = function (slide) {
    var image = display.find('.slider__item-pic');
